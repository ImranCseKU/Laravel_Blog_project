  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <h1 class="font-weight-bold mb-3" style="color:#DCDCDC">Add Blogger</h1>
          <p>
          ...
          <form action="{{route('store.blogger')}}" method="post">
              @csrf
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Blogger Name</label>
                  <input type="text" class="form-control" placeholder="Blogger Name" id="name" name="name">
                  </div>
              </div>
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Blogger Email</label>
                  <input type="email" class="form-control" placeholder="Blogger email" id="email" name="email">
                  </div>
              </div>
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Blogger Email</label>
                  <input type="text" class="form-control" placeholder="Blogger Phone" id="phone" name="phone">
                  </div>
              </div>
              <br>
