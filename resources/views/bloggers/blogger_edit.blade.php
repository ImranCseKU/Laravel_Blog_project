  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <h1 class="font-weight-bold mb-3" style="color:#DCDCDC">Update Blogger Details</h1>
          <p>
            <a href="{{route('all.blogger')}}" class="btn btn-success">All Blogger</a>
          </p>
          ...
          <form action="{{  route('update.blogger',  ['id'=>$a_blogger->id] )  }}" method="post">
              @csrf
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Blogger Name</label>
                  <input type="text" class="form-control" value="{{$a_blogger->name}}" id="name" name="name">
                  </div>
              </div>
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Blogger Email</label>
                  <input type="email" class="form-control" value="{{$a_blogger->email}}" id="email" name="email">
                  </div>
              </div>
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Blogger Email</label>
                  <input type="text" class="form-control" value="{{$a_blogger->phone}}" id="phone" name="phone">
                  </div>
              </div>
              <br>
