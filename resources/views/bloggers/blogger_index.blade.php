    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-11 col-md-10 mx-auto">
                ...
                <p>
                    <a href="{{URL::to('bloggers') }}" class="btn btn-info">Add Blogger</a>

                </p>
                <h1 class="font-weight-bold mb-3" style="color:#DCDCDC">Blogger List</h1>
                <table class="table table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $row->phone }}</td>
                            <td>
                                <a href="{{URL::to('edit/blogger/'.$row->id)}}" class="btn btn-sm btn-info">Edit</a>
                                <a href="{{URL::to('delete/blogger/'.$row->id)}}" id="delete"  class="btn btn-sm btn-danger">Delete</a>
                                <a href="{{URL::to('view/blogger/'.$row->id)}}" class="btn btn-sm btn-success">View</a>
                            </td>
                        </tr>
                    </tbody>
                    @endforeach
