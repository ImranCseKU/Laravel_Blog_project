    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-11 col-md-10 mx-auto">
                ...
                <h1 class="font-weight-bold mb-3" style="color:#DCDCDC">All Blog Post</h1>
                <table class="table table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $row->name }}</td>
                            <td>{{ $row->title }}</td>
                            <td><img src="{{asset('public/'. $row->image )}}" style="height:50px; width=70px;" alt="img"></td>
                            <td>
                                <a href="{{URL::to('edit/post/'.$row->id)}}" class="btn btn-sm btn-info">Edit</a>
                                <a href="{{URL::to('delete/post/'.$row->id)}}" id="delete"  class="btn btn-sm btn-danger">Delete</a>
