  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <form action="{{URL::to('update/category/'. $edited_category->id)}}" method="post">
              @csrf
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Category Name</label>
                  <input type="text" class="form-control" value={{$edited_category->name}} id="name" name="name">
                  </div>
              </div>
              <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                  <label>Category Status</label>
                  <input type="text" class="form-control" value={{$edited_category->status}} id="name" name="status">
                  </div>
              </div>
              <br>
