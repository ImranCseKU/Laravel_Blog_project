    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <h1 class="font-weight-bold mb-3" style="color:#DCDCDC">Categories Details:</h1>
                <div>
                    <ol>
                        <li>Category Name  : {{ $categoryDetails->name}}</li>
                        <li>Category Status: {{ $categoryDetails->status}}</li>
                        <li>Created At     : {{ $categoryDetails->created_at}}</li>
                    </ol>
