  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <form action="{{URL::to('store/post')}}" method="post" enctype="multipart/form-data" >
            @csrf
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                <label>Post Title</label>
                <input type="text" name="post_title" class="form-control" placeholder="Title" id="name" required>
              </div>
            </div>
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                ...
                <textarea rows="5" name="post_details" class="form-control" placeholder="Details" id="message" required></textarea>
              </div>
            </div>
            <br>
            <div id="success"></div>
